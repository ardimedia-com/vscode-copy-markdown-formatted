...
export const STYLES: Record<string, string> = {
  h1: `font-family: ${FONT_BODY}; font-size: 24pt; font-weight: 600; color: ${COLOR_TEXT}; margin: 16px 0 8px 0;`,
  h2: `font-family: ${FONT_BODY}; font-size: 18pt; font-weight: 600; color: ${COLOR_TEXT}; margin: 14px 0 6px 0;`,
  h3: `font-family: ${FONT_BODY}; font-size: 16pt; font-weight: 600; color: ${COLOR_TEXT}; margin: 12px 0 4px 0;`,
